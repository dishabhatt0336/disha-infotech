      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
            <div className="hover:shadow-lg bg-gradient-to-br from-blue-50 to-blue-50 p-8 rounded-2xl">
            ...
            <div className="hover:shadow-lg bg-gradient-to-br from-orange-50 to-orange-50 p-8 rounded-2xl">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <div key={idx} className="hover:shadow-lg bg-white p-6 rounded-xl shadow-sm text-center">
                ...
                <h3 className="text-3xl font-bold text-orange-600 mb-3">{value.title}</h3>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { name: 'Gaurav Bhatt', role: 'Founder & CEO', bio: '10+ years in ELV(Extra Low Volatge) systems.', image: 'animated3.jpeg' },
              { name: 'Disha Bhatt', role: 'CTO', bio: 'Tech lead handling software development.', image: 'animated.jpg' },
              { name: 'Khushali Bhatt', role: 'Marketing', bio: 'Expert in scaling the organizations.', image: 'animated2.jpg' }
            ].map((member, idx) => (
              <div key={idx} className="hover:shadow-lg rounded-2xl py-8 text-center">
                <div className="w-32 h-32 rounded-full mx-auto mb-4 flex items-center justify-center text-white text-4xl font-bold" 
