        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="hover:shadow-lg bg-gradient-to-br from-gray-50 to-gray-50 p-6 rounded-xl border border-gray-200">
                <h3 className="text-2xl font-semibold text-orange-600 mb-3">{perk.title}</h3>
                <p className="text-gray-800">{perk.desc}</p>
              </div>
            ))}
          </div>
        </div>
